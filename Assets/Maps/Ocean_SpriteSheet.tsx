...
<tileset version="1.10" tiledversion="1.11.2" name="Ocean_SpriteSheet" tilewidth="32" tileheight="32" tilecount="16" columns="8">
 <image source="../Images/Ocean_SpriteSheet.png" width="256" height="64"/>
 <tile id="0">
  <animation>
