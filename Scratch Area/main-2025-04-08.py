...
PIERMASTER_IMAGE = '/home/ron/python/tilemapLearning/64piermaster1.png'
PLAYER_IMAGE = '/home/ron/python/tilemapLearning/64gentleman.png'
MAP_PATHS = {
    'sea': "/home/ron/python/tilemapLearning/sea.tmx",
    'palace': "/home/ron/python/tilemapLearning/mayorsHouse.tmx",
    'streets': "/home/ron/python/tilemapLearning/streets_map.tmx"
}
...
class Game:
    ...
    def run(self) -> None:
        ...
        while self.running:
            ...
            if self.current_map == 'sea' and self.player.rect.x <= 0:
